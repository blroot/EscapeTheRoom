...
unrealRootPath=/home/blroot/Documents/UnrealEngine
EscapeTheRoomRootPath=/home/blroot/Documents/Unreal Projects/EscapeTheRoom

gameProjectFile=/home/blroot/Documents/Unreal Projects/EscapeTheRoom/EscapeTheRoom.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(EscapeTheRoomSource.pri)
include(EscapeTheRoomHeader.pri)
include(EscapeTheRoomConfig.pri)
include(EscapeTheRoomIncludes.pri)
include(EscapeTheRoomDefines.pri)
...
EscapeTheRoom-Linux-Debug.commands = $$build EscapeTheRoom Linux Debug  -project="\"$$gameProjectFile\"" $$args
EscapeTheRoom-Linux-DebugGame.commands = $$build EscapeTheRoom Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EscapeTheRoom-Linux-Shipping.commands = $$build EscapeTheRoom Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EscapeTheRoom-Linux-Test.commands = $$build EscapeTheRoom Linux Test  -project="\"$$gameProjectFile\"" $$args
EscapeTheRoom.commands = $$build EscapeTheRoom Linux Development  -project="\"$$gameProjectFile\"" $$args

EscapeTheRoomEditor-Linux-Debug.commands = $$build EscapeTheRoomEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
EscapeTheRoomEditor-Linux-DebugGame.commands = $$build EscapeTheRoomEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EscapeTheRoomEditor-Linux-Shipping.commands = $$build EscapeTheRoomEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EscapeTheRoomEditor-Linux-Test.commands = $$build EscapeTheRoomEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
EscapeTheRoomEditor.commands = $$build EscapeTheRoomEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	EscapeTheRoom-Linux-Debug \
	EscapeTheRoom-Linux-DebugGame \
	EscapeTheRoom-Linux-Shipping \
	EscapeTheRoom-Linux-Test \
	EscapeTheRoom \
	EscapeTheRoomEditor-Linux-Debug \
	EscapeTheRoomEditor-Linux-DebugGame \
	EscapeTheRoomEditor-Linux-Shipping \
	EscapeTheRoomEditor-Linux-Test \
	EscapeTheRoomEditor \
