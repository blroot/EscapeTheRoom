...
EscapeTheRoom-Linux-Debug:
	 $(PROJECTBUILD) EscapeTheRoom Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeTheRoom-Linux-DebugGame:
	 $(PROJECTBUILD) EscapeTheRoom Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeTheRoom-Linux-Shipping:
	 $(PROJECTBUILD) EscapeTheRoom Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeTheRoom-Linux-Test:
	 $(PROJECTBUILD) EscapeTheRoom Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeTheRoom:
	 $(PROJECTBUILD) EscapeTheRoom Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeTheRoomEditor-Linux-Debug:
	 $(PROJECTBUILD) EscapeTheRoomEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeTheRoomEditor-Linux-DebugGame:
	 $(PROJECTBUILD) EscapeTheRoomEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeTheRoomEditor-Linux-Shipping:
	 $(PROJECTBUILD) EscapeTheRoomEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeTheRoomEditor-Linux-Test:
	 $(PROJECTBUILD) EscapeTheRoomEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

EscapeTheRoomEditor:
	 $(PROJECTBUILD) EscapeTheRoomEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
